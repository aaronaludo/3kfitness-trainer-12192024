import { StyleSheet, Text, View, Image, FlatList, TouchableOpacity, Dimensions, ImageBackground, Platform } from 'react-native'
...
const TrainerProfileScreen = () => {
    ...
    function collapsibleHeader() {
        ...
        const renderNavBar = () => {
            return (
                <View style={{ marginVertical: Platform.OS == 'ios' ? 0 : Sizes.fixPadding + 5.0, marginHorizontal: Sizes.fixPadding * 2.0, flexDirection: isRtl ? 'row-reverse' : 'row', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        const renderItem = ({ item }) => {
            return (
                <ImageBackground
                    ...
                    style={{ width: width / 2.5, height: (width / 2.5) - 30.0, marginHorizontal: Sizes.fixPadding, }}
    ...
    function feeAndBookButton() {
        return (
            <View style={{ ...styles.feeAndBookButtonWrapStyle, flexDirection: isRtl ? 'row-reverse' : 'row' }}>
                ...
                <TouchableOpacity
                    activeOpacity={0.7}
                    onPress={() => navigation.push('subscriptionDetail/subscriptionDetailScreen')}
