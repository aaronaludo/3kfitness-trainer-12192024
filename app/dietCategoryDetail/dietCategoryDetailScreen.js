import { Text, View, Image, ScrollView, ImageBackground, Dimensions, TouchableOpacity, } from 'react-native'
...
const DietCategoryDetailScreen = () => {
    ...
    function categoryDetail() {
        return (
            <BottomSheet
                ...
                sliderMaxHeight={height - 120.0}
                wrapperStyle={{ paddingHorizontal: 0.0, elevation: 0.0, overflow: 'hidden' }}
                ...
                {(onScrollEndDrag) => (
                    <ScrollView
                        ...
                        contentContainerStyle={{
                            flexGrow: 1, paddingHorizontal: Sizes.fixPadding * 2.0,
                        }}
                    >
            ...
            <View>
                ...
                </Text>
                {
                    dietPlans.map((item, index) => (
                        <TouchableOpacity
                            activeOpacity={0.7}
                            onPress={() => navigation.push('dietDetail/dietDetailScreen')}
                            key={`${item.id}`}
                        ...
                        >
                            ...
                            />
                            <View style={{ alignItems: isRtl ? 'flex-end' : 'flex-start', flex: 1, marginLeft: isRtl ? 0.0 : Sizes.fixPadding + 5.0, marginRight: isRtl ? Sizes.fixPadding + 5.0 : 0.0 }}>
    ...
    function dietCategoryAndPlanInfo() {
        return (
            <View style={{ alignItems: isRtl ? 'flex-end' : 'flex-start', marginTop: Sizes.fixPadding + 5.0 }}>
